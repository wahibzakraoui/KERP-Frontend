        ...
        <div class="d-flex flex-column-fluid flex-center">
          ...
          <div class="login-form login-signin">
            ...
            >
              ...
              <div v-if="errors.length > 0" class="alert alert-custom alert-danger fade show" role="alert">
                  <div class="alert-icon"><i class="flaticon-warning"></i></div>
                  <div class="alert-text">{{ errors[0] }}</div>
              ...
              <div v-if="isAuthenticated" class="alert alert-custom alert-success fade show" role="alert">
                  <div class="alert-icon"><i class="flaticon-check-mark"></i></div>
                  <div class="alert-text">Connexion reussie, redirection...</div>
                  <div class="alert-close">
                      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                          <span aria-hidden="true"><i class="ki ki-close"></i></span>
                      </button>
              ...
              <div class="pb-lg-0 pb-5">
                <button
                  ...
                  v-bind:class="{ 'spinner': isLoading, 'spinner-light': isLoading, 'spinner-right' : isLoading }"
                >
                  Sign In
                </button>
                <button
