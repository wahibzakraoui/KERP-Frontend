<template>
  <ul class="menu-nav">
    ...
    <li class="menu-section">
      <h4 class="menu-text">Transformation</h4>
    ...
    <li
      ...
      v-bind:class="{ 'menu-item-open': hasActiveChildren('reception') }"
    >
          ...
          >
            ...
            >
              <a :href="href" class="menu-link" @click="navigate">
                ...
                <span class="menu-text">Liste de Receptions</span>
              </a>
            </li>
          </router-link>
          ...
          >
            ...
            >
              <a :href="href" class="menu-link" @click="navigate">
                ...
                <span class="menu-text">Ajouter une Reception</span>
              </a>
            </li>
          </router-link>
